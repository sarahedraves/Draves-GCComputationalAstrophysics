...
def Euler(diffeq, r0s, *args, t0=0, h=0.1, N=None, maxt=None): #args is to make this generalizable so the necessary arguments can vary based on the parameters for diffeq
    ...
    for i, t in enumerate(Ts[1:],start=1): #start at second point
        Rs[i]=Rs[i-1]+h*diffeq(Rs[i-1],t, *args)
    return Ts, Rs
