...
def threestars(state,t,m1=1,m2=1,m3=1):
    r1=state[0:4]
    r2=state[4:8]
    r3=state[8:12]
...
def threestarsandplanet(state,t,m1=1,m2=1,m3=1):
    r1=state[0:4]
    r2=state[4:8]
    r3=state[8:12]
    planet=state[12:16]
...
def twostars(state,t,m1=1,m2=1):
    r1=state[0:4]
    r2=state[4:8]
...
def twostarsandplanet(state,t,m1=1,m2=1):
    r1=state[0:4]
    r2=state[4:8]
    planet=state[8:12]
...
def oneorbit(r,t,M=1,G=1): #where r is the vector (x,y,vx,vy)
    x=r[0]
    y=r[1]
    vx=r[2]
    vy=r[3]
